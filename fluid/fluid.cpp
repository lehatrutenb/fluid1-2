...
using namespace std; // SORRY, code had that string before I got it so not to write std in old code - but I'have written it in my places
...
#ifndef TO_PRINT
    std::cout << "CARE, NOT TO PRINT IS DEFINED" << std::endl;
#endif
    cout.tie(0);
